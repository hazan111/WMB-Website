...
// Tree-shake friendly icon imports - only import what we use
import {
  Building2,
  MapPin,
  Package,
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button 
                        ...
                        aria-label={`${company.name} şirketini düzenle`}
                      >
                        <Edit className="w-4 h-4 text-slate-400" aria-hidden="true" />
                      </button>
                    </div>
                  </div>
                </div>
  ...
  return (
    <section id="web" className="py-32 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Features Grid */}
        {/* 
          Example Below-the-fold Image Usage (lazy-loaded with aspect-ratio):
          <OptimizedImage
            src="/images/web-feature.jpg"
            srcSet="/images/web-feature-400w.jpg 400w, /images/web-feature-800w.jpg 800w"
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 400px"
            alt="Web feature description"
            width={800}
            height={600}
            isLCP={false}
            aspectRatio="4/3"
